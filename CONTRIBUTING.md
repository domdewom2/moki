# Contributing to Moki

Thanks for your interest in contributing! Moki is a simple music player for kids, and we want to keep it that way — simple, reliable, and fun.

## Development Setup

You need a Raspberry Pi with Moki installed (see the [README](README.md)). Edit code on your machine, then sync and test on the Pi:
