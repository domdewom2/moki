"""
Renderer - All drawing/rendering logic for the Moki UI.
"""
import logging
import time
import math
...
class Renderer:
    """Handles all drawing/rendering for Moki UI."""
    ...
    def _draw_empty_state(self, ctx: RenderContext):
        ...
        if not ctx.has_network:
            ...
            if ctx.app_screen == AppScreen.CHECKPOD:
                ...
                line1 = self._render_text_rotated('Play to Moki via Spotify', self.font_medium, COLORS['text_secondary'])
            line1_rect = line1.get_rect(center=(center_x - 30, center_y))
            self.screen.blit(line1, line1_rect)
