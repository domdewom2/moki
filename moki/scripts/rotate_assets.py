...
Usage:
    python -m moki.scripts.rotate_assets --icons    # Rotate icons only
    python -m moki.scripts.rotate_assets --images   # Rotate cover images only
    python -m moki.scripts.rotate_assets --all      # Rotate everything
"""
import sys
...
def main():
    ...
    if not do_icons and not do_images:
        print("Usage: python -m moki.scripts.rotate_assets [--icons] [--images] [--all]")
        print("\nOptions:")
